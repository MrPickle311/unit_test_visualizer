...
So to full understand this application working go also there.
...
## Use CMake and make without QtCreator

1. Go to build folder
2. Write the following cmake invokation , but specify some directories
...
-DQT_QMAKE_EXECUTABLE:STRING=/home/USER/Qt/5.15.2/gcc_64/bin/qmake 
-DCMAKE_PREFIX_PATH:STRING=/home/USER/Qt/5.15.2/gcc_64 
...
3. Run ``` make ```
4. Run ``` ./uart_unit_test_visualizer ```
